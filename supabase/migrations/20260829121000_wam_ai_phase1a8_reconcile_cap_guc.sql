-- Phase 1A.8: recreate reconcile_customer_batch with session-only raised cap via GUC
-- Default max remains 250; finalize_reconcile_session sets wam_ai.reconcile_max_rows=5000.
