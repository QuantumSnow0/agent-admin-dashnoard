...
## Tool namespaces (Phase 1A.2a)

- `wam.business.analytics.*` — reporting aggregates
- `wam.business.operations.*` — open-book record lookup
- `wam.business.dispatch.*` — dispatch recommendations (1A.2a: `recommend_agents_for_lead` only)
