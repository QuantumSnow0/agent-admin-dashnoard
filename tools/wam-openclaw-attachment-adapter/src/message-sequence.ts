 ...
 */
export function processMessageReceivedSequence(
  ...
  const observed = store.observeInstructionMessage(
    sessionKey,
    {
    ...
    nowMs,
    { inboundGeneration: opts.inboundGeneration, abortSignal: opts.abortSignal },
  );
