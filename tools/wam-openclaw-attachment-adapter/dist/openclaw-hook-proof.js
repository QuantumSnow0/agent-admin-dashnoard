...
export const OPENCLAW_HOOK_ORDERING_PROOF = {
    ...
    residualRisk: "A delayed/out-of-order before_prompt_build after instruction_observed cannot be distinguished from the instruction prompt without messageId",
