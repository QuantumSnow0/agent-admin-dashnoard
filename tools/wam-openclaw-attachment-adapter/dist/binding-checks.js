 ...
 */
export function assertMessageIdentityMatch(binding, identity) {
...
export function assertPendingIdentityMatch(binding, turn) {
 ...
 */
export function assertBindingMatchesTurn(binding, turn, nowMs = Date.now(), store) {
    ...
    if (turn.sessionGeneration != null &&
    ...
    if (binding.attachmentIndex == null ||
